...
public class HomeWorkRPS2 {
    ...
    public static String rockPaperScissors(String player1, String player2){
        ...
        if(!checkInputValid(player1,player2)){
            return answer = "Input values are not valid";
        }

        if ((player1.equals ("rock") && (player2.equals("lizard")|| player2.equals("scissors")))
    ...
    public static boolean checkInputValid(String player1, String player2){
        return player1.matches("rock|paper|scissors|spock|lizard") && player2.matches("rock|paper|scissors|spock|lizard");
    }
