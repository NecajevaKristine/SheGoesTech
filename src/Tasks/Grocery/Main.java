...
public class Main {
    ...
    private static void main(String[] args) {
       ...
       while (!quit){
        ...
        groceryList.addGroceryItem("9 Beers");
        groceryList.printGroceryList();

        groceryList.removeGroceryItem("Bread");
        groceryList.removeGroceryItem("Beer");
        groceryList.printGroceryList();

        groceryList.modifyGroceryItem(1,"Orange");
        groceryList.printGroceryList();

        System.out.println(groceryList.searchItem("Orange"));
        System.out.println(groceryList.searchItem("Beer"));
